...
# Added log-return lags, momentum filters, sign features for directional accuracy
FEATURES = [
    'open', 'high', 'low', 'close', 'volume',
    'log_return_lag1', 'log_return_lag2', 'log_return_lag3',
    'momentum_5', 'momentum_10', 'sign_return',
    'vader_sentiment'  # Added VADER if beneficial
]
...
# Smoothing factor for prediction stability
